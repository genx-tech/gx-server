...
class WebServer extends Routable(Runnable(ServiceContainer)) {
  ...
  _getFeatureFallbackPath() {
    ...
    pathArray.splice(1, 0, path.resolve(__dirname, Literal.SERVER_FEATURES_PATH), path.resolve(__dirname, Literal.APP_FEATURES_PATH), path.resolve(__dirname, Literal.FEATURES_PATH));
    return pathArray;
  }
}
